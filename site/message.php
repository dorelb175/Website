...
else if($_SESSION["message"] == "MustLogin")
   $msg = "עליך להיות מחובר על מנת לצפות בדף זה";
else if($_SESSION["message"] == "IsExist")
   $msg = "שם משתמש זה כבר קיים";
else if($_SESSION["message"] == "MustAdmin")
   $msg = "עליך להיות מנהל על מנת לצפות בדף זה";
else if($_SESSION["message"] == "WrongUser")
   $msg = "שם משתמש זה אינו קיים";
else if($_SESSION["message"] == "LoginFailed" || $_COOKIE['Login'] == sha1("Failed"))
   $msg = "לא ניתן להתחבר לאחר 5 ניסיונות כושלים<br /><br />תוכל להתחבר מחדש בעוד 10 דקות<br /><br /><a href=index.php?page=forgotten_pass><b>שחזור סיסמה</b></a>";
else if($_SESSION['message'] == 'isLogin')
   $msg = "הינך כבר מחובר";
else if($_SESSION['message'] == "AlreadyLogin")
   $msg = "משתמש זה כבר מחובר";
else if($_SESSION['message'] == 'Banned')
   $msg = "הינך מושעה מהאתר בכתובת: ".$_SERVER['REMOTE_ADDR'];
else 
   $msg = "שגיאה";
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<div id="err_message"><?php echo $msg; ?></div>
				</div>
				<!-- end #content -->
				<div id="sidebar">
					<ul>
