	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				switch($page)
				{
				   case 'UpdateAcc':require_once('UpdateAcc.php');break;
                   case 'DeleteAcc':require_once('DeleteAcc.php');break;
                   case 'ShowUsers':require_once('ShowUsers.php');break; 
				   ...
				   default:require_once('userHome.php');break;
				}
				?>
				</div>
				<!-- end #content -->
