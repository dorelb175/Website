	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				switch($s)
				{
				   case '1':require_once('season1.php');break;
				   case '2':require_once('season2.php');break;
				   case '3':require_once('season3.php');break;
				   case '4':require_once('season4.php');break;
				   case '5':require_once('season5.php');break;
				   case '6':require_once('season6.php');break;
				   case '7':require_once('season7.php');break;
				   default:require_once('season1.php');break;
				}
				?>
				</div>
				</div>
