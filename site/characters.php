...
switch($c)
{
	case 'Ted':require_once('Ted.html');break;
	case 'Robin':require_once('Robin.html');break;
	case 'Marshall':require_once('Marshall.html');break;
	case 'Lily':require_once('Lily.html');break;
	case 'Barney':require_once('Barney.html');break;
    default:require_once('charHome.html');break;
}
?>
				</div>
				<!-- end #content -->
