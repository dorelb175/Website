	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				switch($page)
				{
                   case 'UpdateUser':require_once('UpdateUser.php');break;
                   case 'DeleteUser':require_once('DeleteUser.php');break;
	               case 'AdminShowUsers':require_once('AdminShowUsers.php');break;
                   case 'AdminShowUsersBy':require_once('AdminShowUsersBy.php');break;
				   case 'Send_PM':require_once('SendPm.php');break;
                   case 'Incoming_Messages':require_once('incoming_messages.php');break;
	               case 'Outgoing_Messages':require_once('outgoing_messages.php');break;
				   case 'Logout':require_once('Logout.php');break;
				   default:require_once('AdminHome.php');break;
				}
				?>
				</div>
				<!-- end #content -->
